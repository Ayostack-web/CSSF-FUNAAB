...
<section className="bg-blue-100 py-8 text-center">
  ...
  <div className="bg-gray-100 p-6 rounded-lg inline-block shadow-md">
    <p className="text-lg font-semibold">Opay Account Name:</p>
    <p className="text-xl text-black-600">XYZ Campus Fellowship</p>
    <p className="mt-2 text-lg font-semibold">Opay Number:</p>
    <p className="text-xl text-black-600">08012345678</p>
  </div>
