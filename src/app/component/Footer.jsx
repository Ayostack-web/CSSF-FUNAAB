...
" className="cursor-pointer transition-transform duration-300 text-blue-100 no-underline select-none hover:scale-130 hover:text-[#9bb6e0]">    <FaTelegram/>  </a>
    ...
    <p className="mt-4 text-sm text-gray-400">
      © 2026 CSSF FUNAAB. All rights reserved. | Built By Ayokunle Shittu.
    </p>
