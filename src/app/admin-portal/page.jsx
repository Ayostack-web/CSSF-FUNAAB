...
import BannerAdmin from "../component/BannerAdmin"; // This is for Banners
    ...
    <div className="flex flex-col gap-8 w-full max-w-2xl">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl border border-blue-100">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-blue-900">Upload Sermon</h2>
          <button onClick={() => setIsAdmin(false)} className="text-xs text-red-500 hover:underline">
            Logout
          </button>
        </div>
      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl border border-blue-100">
        <h2 className="text-xl font-bold text-blue-900 mb-4">Live Sermons</h2>
